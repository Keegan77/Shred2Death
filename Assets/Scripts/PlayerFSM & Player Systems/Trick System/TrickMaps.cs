...
public static class TrickMaps
{
    ...
    static Trick Ollie        = new Trick("None", 5, 3, .2f, jumpTrick, 0, CustomTrickMethods.OllieFunc, canBeInterrupted:true, useOnRelease:true); //less ammo bc it's the basic trick & you're always jumping around
